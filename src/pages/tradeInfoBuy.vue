                            ...
                            <div class="trade-right-box">
                                ...
                                <div class="trade-operation">
                                    <div class="trade-price-input">
                                        <p class="price-input-list">
                                            <Poptip trigger="focus" :content="text1" style="width: 100%;">
                                                <Input @on-change="transform1" v-model="buyPrice" size="large" placeholder="请输入金额" style="width: 450px" :readonly="readonlyP">
                                        ...
                                        <p class="price-input-list">
                                            <Poptip trigger="focus" :content="text2" style="width: 100%;">
                                                <Input @on-change="transform2" v-model="nuyNum" size="large" placeholder="请输入数量" style="width: 450px">
                                    ...
                                    <div class="price-box">
                                        ...
                                        <button class="btn-trade-in" @click="submit" :disabled="disa">{{btnType}}</button>
                                    </div>
                                </div>
