                ...
                <Row>
                    ...
                    <div class="leftmenu">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li class="">
                                <router-link to="/membercenter/safe">安全设置</router-link>
                            </li>
                            <li class="">
                                <router-link to="/membercenter/account">账户设置</router-link>
                            </li>
                            <!-- <li class="">
                                <router-link to="/membercenter/myPromotion">我的推广</router-link>
                            </li> -->
                        </ul>
                    </div>
                    </Col>
