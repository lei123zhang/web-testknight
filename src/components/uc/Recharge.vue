                    ...
                    <div class="table-inner action-box open">
                        ...
                        <div class="action-content">
                            <div class="action-body">
                                ...
                                <p class="acb-p2">• 请勿向上述地址充值任何非{{coinType}}资产，否则资产将不可找回。<br>• 您充值至上述地址后，需要整个网络节点的确认，1次网络确认后到账，6次网络确认后可提币。<br>• 最小充值金额：0.001 BTC，小于最小金额的充值将不会上账。<br>• 您的充值地址不会经常改变，可以重复充值；如有更改，我们会尽量通过网站公告或邮件通知您。<br>• 请务必确认电脑及浏览器安全，防止信息被篡改或泄露。</p>
                            </div>
                        </div>
                        <div class="action-content">
                            <div class="action-body">
