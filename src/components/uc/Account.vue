                    ...
                    <div class="account-in">
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <a class="btn" v-if="user.bankVerified==1" @click="showItem(1)">修改</a>
                                <a class="btn" v-else @click="showItem(1)">绑定</a>
                            </div>
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <a class="btn" v-if="user.aliVerified==1" @click="showItem(2)">修改</a>
                                <a class="btn" v-else @click="showItem(2)">绑定</a>
                            </div>
                                    ...
                                    <Form ref="formValidate2" :model="formValidate2" :rules="ruleValidate" :label-width="100">                                    
                                        <Row>
                                            <Col span="8">
                                                ...
                                                <img v-if='isAliImg' alt="上传图片"  id="aliImg" style="width: 200px;height: 200px;" :src="aliImg">
                                                <img v-else alt="上传图片" id="aliImg" style="width: 50px;height: 50px;" :src="aliImg">
                                                <div class="acc_sc">
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <!-- <a class="btn" v-if="user.wechatVerified==1" @click="noName">修改</a> -->
                                <a class="btn" v-if="user.wechatVerified==1" @click="showItem(3)">修改</a>
                                    ...
                                    <Form ref="formValidate3" :model="formValidate3" :rules="ruleValidate" :label-width="85">
                                        <Row>
                                            <Col span="8">
                                                ...
                                                <img v-if='isWeImg' alt="上传图片" id="weImg" style="width: 200px;height: 200px;" :src="weImg">
                                                <img v-else  alt="上传图片" id="weImg" style="width: 50px;height: 50px;" :src="weImg">
                                                <div class="acc_sc">
...
export default {
    ...
    data() {
        ...
        return {
            ...
            aliImg:require('../../assets/img/transparent.png'),
            isAliImg:false,
            aliPreview:'',
            weImg:require('../../assets/img/transparent.png'),
            isWeImg:false,
            wePreview:'',
            ...
            this.$http.post(this.host + '/uc/approve/account/setting').then(response => {
                ...
                if (resp.code == 0) {
                    ...
                    if(this.aliImg==null || this.aliImg==''){
                        this.aliImg=require('../../assets/img/transparent.png');
                        this.isAliImg=false;
                    ...
                    if(this.weImg==null || this.weImg==''){
                        this.weImg=require('../../assets/img/transparent.png');
                        this.isWeImg=false;
                    }else{
                        this.isWeImg=true;
                    }
                    ...
                    this.msg = resp.message
                    this.$Message.error(this.msg);
                    // if(this.msg=='请先完成实名认证'){
                        var that=this;
                        setTimeout(function(){
                            that.$router.push('/membercenter/safe');
                        },1000)
                    // }
                }
            })
