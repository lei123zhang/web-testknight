<template>
    <div class="nav-right tradeCenter" style="height:1150px">
...
export default {
    ...
    methods: {
        ...
        getAd(pageNo,advertiseType,isCertified) {
            //获取广告
            ...
            params['isCertified'] =isCertified;
         ...
         this.pageNo = pageNo;
            if(this.isCertified==true){          
                this.isCertifiedCode=1
                   this.getAd(pageNo,0,1);
            }else{
                this.isCertifiedCode=0            
                 this.getAd(pageNo,0,0);
            };       
        },
        reloadAd(){
            this.getAd(1,0,0);
